...
typedef struct ObsDetInstance{

	float camera_height;
	float theta_Init;
	float cameraInternalParam_fx;
	float cameraInternalParam_fy;
	float cameraInternalParam_cx;
	float cameraInternalParam_cy;
